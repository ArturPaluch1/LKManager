...
public class MeczDAOImpl implements MeczDAO {
    ...
    @Autowired
    public MeczDAOImpl(EntityManager entityManager) {
...
e.printStackTrace();
    ...
    public List<Match> findAllByTerminarzIdAndRundaId(long terminarzId, int rundaId) {
        ...
        try {
            ...
            String hql = "Select m from Match m inner join  " +
                    "Runda r on r.id=m.runda.id  inner join "+
